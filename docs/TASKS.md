...
## 🌱 Future Ideas (Product Vision)

### 1. Idea Clustering & “Breadth” Analysis
- Group ideas by similar pains or patterns (embeddings / keywords).
- Measure how frequently certain “pains” appear and their engagement.
- Show “problem maps” across themes (e.g., devtools, creator tools, health).

### 2. Breadth & Depth Model of Analysis
- **Breadth:** track which topics are trending and growing in activity.
- **Depth:** deep-dive into top ideas by score:
  - competitor research (ProductHunt, GitHub, Google),
  - evaluate market feasibility and willingness to pay,
  - auto-generate one-pager summaries.

### 3. Trend Tracker & Validation Layer
- **Trend Tracker:** visualize time dynamics of idea clusters.
- **Idea Validation:** check for existing similar products and mark ideas as  
  `validated / saturated / unique opportunity`.
